...
void kernel_main()
{
    ...
    const uint32_t dinp_buffer = get_arg_val<uint32_t>(8);
    ...
    constexpr uint32_t cb_inp = get_compile_time_arg_val(3);
    constexpr uint32_t cb_dout = get_compile_time_arg_val(4);
    constexpr uint32_t cb_weight = get_compile_time_arg_val(5);
    constexpr uint32_t cb_mean = get_compile_time_arg_val(6);
    constexpr uint32_t cb_rstd = get_compile_time_arg_val(7);
    constexpr uint32_t cb_dinp = get_compile_time_arg_val(8);
    constexpr uint32_t cb_dweight = get_compile_time_arg_val(9);
    constexpr uint32_t cb_dbias = get_compile_time_arg_val(10);
