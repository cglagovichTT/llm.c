...
void kernel_main()
{
    ...
    constexpr uint32_t cb_identity_scalar = get_compile_time_arg_val(1);
    constexpr uint32_t cb_mean_scalar = get_compile_time_arg_val(2);
    constexpr uint32_t cb_out_dinp = get_compile_time_arg_val(3);
    constexpr uint32_t cb_out_dweight = get_compile_time_arg_val(4);
    constexpr uint32_t cb_out_dbias = get_compile_time_arg_val(5);
